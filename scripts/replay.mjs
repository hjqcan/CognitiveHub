...
//   node scripts/replay.mjs <dir> [--intent <id>] [--run <id>] [--limit <n>] [--reevaluate jev]
...
import { MemoryDecisionStore, MemoryJournal, MemoryRunStore, reevaluate, timeline } from '../dist/index.js';

const [dir, ...rest] = process.argv.slice(2);
if (!dir) { console.error('Usage: node scripts/replay.mjs <dir> [--intent <id>] [--run <id>] [--limit <n>] [--reevaluate jev]'); process.exit(2); }
